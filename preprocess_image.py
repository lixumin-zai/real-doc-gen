...
def main():
    root_path = "/home/lixumin/project/data/question-data/"
    ...
    for image_path in tqdm.tqdm(images_path):
        ...
        boxes = process.cut_question(rotated_img)
        result = []
        for box in boxes:
        ...
        rotated_img.save(f"/home/lixumin/project/data/question-data/images/{image_name}", format="JPEG")
        
        image_url = f"http://172.20.253.222:65432/{image_name}"
        infos.append({
            "data": {
                "image": image_url 
            },
